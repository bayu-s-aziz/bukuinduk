    ...
    <div class="col-lg-9">
      <form action="/admin/grup" method="post">
        ...
        <div class="input-group mb-3">
          <span class="input-group-text bg-light">Nama Kelompok</span>
          <input type="text" class="form-control @error('nama') is-invalid @enderror" placeholder="Contoh : A/B/C" name="nama">
          @error('nama')
